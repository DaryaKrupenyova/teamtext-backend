"""
Django settings for teamtext project.
...
WSGI_APPLICATION = 'teamtext.wsgi.application'

# Database
# https://docs.djangoproject.com/en/5.0/ref/settings/#databases

if TEAMTEXT == 'LOCAL_DEV' and not config('FORCE_USE_MYSQL', cast=bool):
    DATABASES = {
        'default': {
